...
Route::group(
    ...
    static function () {
        ...
        Route::get(
            ...
            [App\Http\Controllers\Summary\View\ResourceTypeController::class, 'index']
        )->name('summary.resource-type.list');

        Route::options(
            'summary/resource-types',
            [App\Http\Controllers\Summary\View\ResourceTypeController::class, 'optionsIndex']
        )->name('summary.resource-type.list.options');
...
Route::group(
    ...
    static function () {
        ...
        Route::post(
            'resource-types',
            [App\Http\Controllers\Action\ResourceTypeController::class, 'create']
        )->name('resource-type.create');

        Route::delete(
            'resource-types/{resource_type_id}',
            [App\Http\Controllers\Action\ResourceTypeController::class, 'delete']
        )->name('resource-type.delete');

        Route::patch(
            'resource-types/{resource_type_id}',
            [App\Http\Controllers\Action\ResourceTypeController::class, 'update']
