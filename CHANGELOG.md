...
- More tests
- Auth review and 90 day timeout on tokens

### Fixed 
- Ordering fix, no fallback ordering

## [v3.19.2] - 2026-09-19
### Change
- Add MySQL tests for PRs, SQLite tests are for speeds

## [v3.19.1] - 2026-09-15
### Fixed
- Cache key length could be too long
- Isolated cache reads
- Fix some flaky tests

## [v3.19.0] - 2026-09-13
### Change
- Upgraded to Laravel 10
- Added composer to the container
- Internal key now required for some auth routes
- All tests are now in the API, not Postman
- Minor bug fixes
