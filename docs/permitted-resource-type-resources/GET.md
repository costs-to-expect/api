...
# Permitted resource type resources - GET

View the resources for a resource type you have access to.

## Request

**URL** : `/v3/auth/user/permitted-resource-types/{permitted_resource_type_id}/resources`
