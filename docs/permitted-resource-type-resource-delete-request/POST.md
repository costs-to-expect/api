...
# Permitted resource type resource - Request delete

Request deletion of a resource for a resource type you have access to. This queues a background job rather than deleting immediately.

## Request

**URL** : `/v3/auth/user/permitted-resource-types/{permitted_resource_type_id}/resources/{resource_id}/request-delete`
